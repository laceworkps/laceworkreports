...
* `--start-time [%Y-%m-%dT%H:%M:%SZ]`: Start time for query period  [default: 2022-04-04T18:38:59Z]
* `--end-time [%Y-%m-%dT%H:%M:%SZ]`: End time for query period  [default: 2022-04-05T18:38:59Z]
