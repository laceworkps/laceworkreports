...
* `--start-time [%Y-%m-%dT%H:%M:%SZ]`: Start time for query period  [default: 2022-04-14T16:25:40Z]
* `--end-time [%Y-%m-%dT%H:%M:%SZ]`: End time for query period  [default: 2022-04-15T16:25:40Z]
