...
* `--start-time [%Y-%m-%dT%H:%M:%SZ]`: Start time for query period  [default: 2022-04-23T21:49:56Z]
* `--end-time [%Y-%m-%dT%H:%M:%SZ]`: End time for query period  [default: 2022-04-24T21:49:56Z]
